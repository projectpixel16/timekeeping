import { toRefs, ref, reactive, computed, provide, inject, getCurrentInstance, watch, resolveComponent, unref, openBlock, createElementBlock, normalizeProps, mergeProps, renderSlot, createBlock, withCtx, createElementVNode, resolveDynamicComponent, createTextVNode, toDisplayString, guardReactiveProps, toHandlers, Transition, normalizeStyle, createCommentVNode, normalizeClass, Fragment, renderList, onMounted, onUnmounted, createVNode, withDirectives, vShow, nextTick } from 'vue';
...
return (_ctx, _cache) => {
  return (typeof __props.icon === 'object' && __props.icon.text)
    ? (openBlock(), createBlock(resolveDynamicComponent(__props.icon.element ? __props.icon.element : 'i'), normalizeProps(mergeProps({ key: 0 }, unref(attributes))), {
        default: withCtx(() => [
    ...
    : (typeof __props.icon === 'object')
      ? (openBlock(), createBlock(resolveDynamicComponent(__props.icon.element ? __props.icon.element : 'i'), normalizeProps(mergeProps({ key: 1 }, unref(attributes))), null, 16 /* FULL_PROPS */))
      : (openBlock(), createElementBlock("i", normalizeProps(mergeProps({ key: 2 }, unref(attributes))), null, 16 /* FULL_PROPS */))
}
}
...
return (_ctx, _cache) => {
  return (__props.badge.text)
    ? (openBlock(), createBlock(resolveDynamicComponent(__props.badge.element ? __props.badge.element : 'span'), normalizeProps(mergeProps({ key: 0 }, unref(attributes))), {
        default: withCtx(() => [
          createTextVNode(toDisplayString(__props.badge.text), 1 /* TEXT */)
        ]),
        _: 1 /* STABLE */
      }, 16 /* FULL_PROPS */))
    : (openBlock(), createBlock(resolveDynamicComponent(__props.badge.element ? __props.badge.element : 'span'), normalizeProps(mergeProps({ key: 1 }, unref(attributes))), null, 16 /* FULL_PROPS */))
}
}
              ...
              ? (openBlock(), createBlock(Transition, {
                  ...
                  default: withCtx(() => [
                    (unref(show))
                      ? (openBlock(), createElementBlock("div", {
                          key: 0,
                          class: normalizeClass(['vsm--child', unref(isMobileItem) && 'vsm--child_mobile']),
                          style: normalizeStyle(unref(isMobileItem) && unref(mobileItemDropdownStyle))
                        }, [
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", {
    ...
    ref: sidebarMenuRef,
    class: normalizeClass([unref(sidebarClass)]),
    style: normalizeStyle({ 'max-width': unref(sidebarWidth) })
  }, [
      ...
      createVNode(script$1, null, {
        default: withCtx(() => [
          createElementVNode("ul", {
            class: "vsm--menu",
            style: normalizeStyle({ width: unref(sidebarWidth) })
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(computedMenu), (item) => {
